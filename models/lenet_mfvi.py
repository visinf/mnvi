...
class LeNetMFVI(nn.Module):
    def __init__(self, num_classes=10, min_variance=1e-5, prior_precision=1e0, kl_div_weight=0.0):
        ...
        self.conv2 = varprop.Conv2dMF(32, 64, kernel_size=5, prior_precision=prior_precision)
        ...
        self.fc1 = varprop.LinearMF(1024, 1024, prior_precision=prior_precision)
        self.relu3 = varprop.ReLU(keep_variance_fn=self._keep_variance_fn)
        self.fc2 = varprop.LinearMF(1024, self._num_classes, prior_precision=prior_precision)
